<%@ Page Title="" Language="C#" MasterPageFile="~/store.Master" AutoEventWireup="true" CodeBehind="oStore.aspx.cs" Inherits="ejder3200.oStore" %>
            ...
            <div class="card">
                <div class="card-inner">
                    ...
                    <div class="card-back">
                        ...
                        <%--<h3>BEFORE</h3>--%>
                        <div class="additional-info">
                            <p> <a href='<%# "esyaDetay.aspx?urun=" + Eval("id") %>'><h4><%# Eval("ad") %></h4> </a> </p>
                            <h4><%# Eval("fiyat") %></h4><h5>TL</h5>
                           <%-- <button class="btn btn-primary">Sepete Ekle</button>--%>
